...
export class InsertFilmsController {
  constructor(
    private insertFilmsUseCase: InsertFilmsUseCase
  ) {}

  public async execute(request : Request, response: Response): Promise<Response> {
		// aqui vamos busca a array de filmes do endpoint e passar como parametro para o use case
		const filmsMock = [
			{
		...
		const teste = await this.insertFilmsUseCase.execute(filmsMock);
